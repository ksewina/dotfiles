...
plugins=(git colored-man-pages ansible colorize command-not-found copydir copyfile chucknorris
kubectl)
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/ks/.anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ks/.anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ks/.anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
